...
//  DONE (1) Create a constant int value to identify the notification
    ...
    private static final int NOTIFICATION_IDENTIFIER = 4003;
...
//          DONE (3) Create an Intent with the proper URI to start the DetailActivity
            ...
            //new Intent(context, DetailActivity.class).setData(todaysWeatherUri);
...
//          DONE (7) Notify the user with the ID WEATHER_NOTIFICATION_ID
            ...
            notificationManager.notify(NOTIFICATION_IDENTIFIER, notificationBuilder.build());
